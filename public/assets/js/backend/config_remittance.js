define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'config_remittance/index' + location.search,
                    add_url: 'config_remittance/add',
                    edit_url: 'config_remittance/edit',
                    del_url: 'config_remittance/del',
                    multi_url: 'config_remittance/multi',
                    import_url: 'config_remittance/import',
                    table: 'config_remittance',
                }
            });
