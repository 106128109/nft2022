define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'calendar_goods/index' + location.search,
                    add_url: 'calendar_goods/add',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'calendar.start_time', title: __('Calendar.start_time'), operate:'RANGE', addclass:'datetimerange', autocomplete:false},
