    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                ...
                showExport: false,
                extend: {
                    index_url: 'chip_users/index' + location.search,
                    add_url: 'chip_users/add',
                    //edit_url: 'chip_users/edit',
                    del_url: 'chip_users/del',
                    //multi_url: 'chip_users/multi',
                    //import_url: 'chip_users/import',
                    table: 'chip_users',
                }
            });
                ...
                columns: [
                    [
                       ...
                       // {field: 'goods_id', title: __('Goods_id')},
                        ...
                        //{field: 'users.id', title: __('Users.id')},
