...
<style lang="scss" scoped>
	.countdown{display: flex;align-items: center;justify-content: center;font-size: 20rpx;color: #fff;
	.day{font-size: 22rpx;display: flex;align-items: center;
		.text{color: #FD3C22;font-size: 32rpx;font-weight: bold;}
	}
	.time{padding: 8rpx;border-radius: 4rpx;box-sizing: border-box;}
