<template>
	<view class="">
		<view class="feltitle">
			...
			<text>我的邀请</text>
			<image src="/static/img/share.png" mode="" @tap="copy(register_url)"></image>
		</view>
		<view class="container">
			...
			<view class="flex flex-between  w560" style="padding-top: 20rpx;">
				<view class="ptb-16 plr-50 size-28 white bg1" @click="save">保存二维码</view>
				<view class="ptb-16 plr-50 size-28 white bg2" @tap="copy(uuid)">复制邀请码</view>
			</view>
