	...
	<view class="content">
		...
		<view class="goodsinfo">
			...
			<view class="iptBox iptBox1 flexBox">
				...
				<view class="center">
					{{info.token_id}}
					<image v-if="info.token_id" class="copy" @tap="copy(info.token_id)" src="../../static/img/my/copy.png" mode=""></image>
				</view>
			</view>
			<view class="iptBox iptBox1 flexBox" v-if="info.number">
				<view class="label" >购买编号</view>
				<view class="center">
				{{info.number}}
				</view>
			</view>
		...
		<view class="footerBox flex_bt">
			<view class="subBtn subBtn1" @tap="openSalePopup()">出 售</view>
		...
		<uni-popup ref="TransferPopup" type="center" :mask-click="false">
			<view class="specs_boxs">
				...
				<view class="flex" style="margin-top: 20rpx ;">
					<input type="number" v-model="pay_password" class="ipt" placeholder-class="iptP"
						placeholder="请输入交易密码" />
				</view>
				<view class="btnBox flex">
